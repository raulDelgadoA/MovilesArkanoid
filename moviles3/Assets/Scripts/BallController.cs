...
public class BallController : MonoBehaviour
{
    ...
    // --- FUNCIÓN HELPER PARA VIBRAR SOLO SI ESTÁ ACTIVADO ---
    void TryVibrate()
    {
#if UNITY_ANDROID || UNITY_IOS
        // Leemos la configuración guardada (1 = Activado, 0 = Desactivado)
        // El '1' es el valor por defecto si no se ha guardado nada.
